...
<template>
  <main style="min-height: 100vh; display: flex; align-items: center; justify-content: center; background: #0a0a0a; color: #eee; font-family: sans-serif;">
    <div style="width: 100%; max-width: 400px; padding: 2rem; border: 1px solid #222; background: #111; border-radius: 8px;">
      ...
      <div v-if="currentUser" style="margin-top: 1.5rem; padding: 1rem; background: #162a19; border: 1px solid #22c55e; border-radius: 4px;">
        <strong>Logged In:</strong>
        <p style="margin: 0.25rem 0; font-size: 0.85rem;">ID: {{ currentUser.id }}</p>
        <p style="margin: 0; font-size: 0.85rem;">Email: {{ currentUser.email }}</p>
      </div>
